        ...
        <div className="companion-side-stack">
          ...
          <Card>
            ...
            <div className="companion-settings-form">
              ...
              <label className="field-label">提醒播报音量<Slider label="提醒播报音量" min={0} max={100} step={5} value={companionDraft.codexBriefVolume} onChange={(codexBriefVolume) => editCompanionDraft({ ...companionDraft, codexBriefVolume })} /><small>个人提醒和任务状态等主动播报单独使用较低音量。</small></label>
