...
export const COMPANION_DEFAULTS = Object.freeze({ name: "小岚", wakePhrase: "小岚小岚", endSmoothWindowMs: 500, idleTimeoutMs: 10000, conversationVolume: 75, codexBriefVolume: 30, wakeEnabled: false });
