...
- No firmware source, Host HID, DeskMate Link, device discovery, serial/HID write, Flash/NVS/eFuse operation or servo contract changed. Classification: `T20_WINDOWS_CODE_BUILD_CONFIRMED / LOCAL_WAKE_PROCESS_SMOKE_PASSED / EXACT_RUNTIME_READY / USER_WAKE_TIMING_AND_AUDIO_HIL_PENDING / FIRMWARE_UNCHANGED`. Next: launch the exact runtime and verify hidden idle, “小智，小智” wake, roughly four-second answer start, ten-second foreground disappearance, repeated wake and one built-in dance beat.
