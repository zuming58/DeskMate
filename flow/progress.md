...
- Windows implementation is committed on `codex/t18-software-closure` at `02df0c349e848b619f27c7f22cfd406648f4b80c`.
...
- Verification: focused wake/manual/expression tests `18/18`; full `npm test` `421/421`; `npm run build:desktop`; packaged InputBridge `--protocol-self-test`; `git diff --check`. Fresh unpacked artifacts: `DeskMate.exe` 202690560 bytes / SHA-256 `020AC0A8CB4085B71F305BE8E33DAF1D5B0CE9234CBB68458FF394A633AB4233`; `app.asar` 113119367 bytes / `6DA27C6006A30A9B30FAFCDA03F010D8368FDBDDA49135EDB1F033941DA147E1`; InputBridge 153525129 bytes / `11F5C9609D0F4A7CB690A46A0AD26EB22394F967B3CED5B5FF2CAC3239E0DB06`.
- The exact fresh package was launched and one owned background PowerShell wake-listener child was observed. This proves the listener is alive, not that real speech reached the system-default microphone. Next HIL: save a new repeated wake phrase while idle, verify the page remains `正在监听`, speak it, then end the session and confirm the capsule hides; also send manual `待命` once and confirm no Codex work event restores square eyes.
