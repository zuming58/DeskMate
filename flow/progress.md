...
- Scope and base: Windows software only on `codex/t12b-companion-layout-timing-settings`, isolated from the exact T12A base `7555d4161b90df000aae600a098ea336e198c743`. Build identity is `t12b-companion-layout-timing-settings-v1`; no firmware, HID, Link or hardware behavior changed.
