...
## Current stage: T22C keyboard-page Tab and KEY3/4 local migration
...
- 自动证据：完整测试 502/502；原生 Electron 交互 50 项、1440×1024 与 960×680 布局通过。桌面包和实际启动证据见最新 progress，不以单测代替硬件验收。
