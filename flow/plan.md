...
- T12B.1 provider endpointing repair is built on `codex/t12b1-provider-endpointing-repair` from exact T12B base `bb0d29b4ce2ad7952fbac3bc6188593655107ab3`. User diagnostics excluded persistence and session-revision freeze: both requested 8000 ms while live turns still used the provider's short endpoint. The repair reduces `StartSession.asr` to only `extra.end_smooth_window_ms`, preserves HIL-selected half-duplex `keep_alive`, and adds an exact 8000 ms outbound vector. Full regression is `270/270`; Windows packaging passes. Exact-package eight-second utterance HIL remains open. Review: [`t12b1-provider-endpointing-root-cause-2026-09-02.md`](../docs/reviews/t12b1-provider-endpointing-root-cause-2026-09-02.md); handoff: [`t12b1-provider-endpointing-repair-2026-09-02.md`](../docs/handoffs/t12b1-provider-endpointing-repair-2026-09-02.md).
