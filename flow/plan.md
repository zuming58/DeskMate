...
| --- | --- | --- | --- |
| T15/T16 current integration | `codex/t15-t16-integration`, tested implementation `0d079a5` | Desktop `358/358` + Windows package/native self-test + launched visual audit; EasyInput Host `14/14` + ESP-IDF v5.5.5 build + app-only flash/readback; Xiaozhi Host `14/14` + ESP-IDF v5.5.3 build + user-reported flash success | `THREE_END_CODE_BUILD_CONFIRMED / DUAL_BOARD_FLASH_COMPLETE / PHYSICAL_PRESET_HIL_PENDING` |
| T15D Windows editor | `codex/t15d-desktop-choreography-editor@0d079a5d72349c7468db8d2c01215b021c026a29`, fast-forwarded into current integration | Strict 2–8 beat Yaw/Pitch/Expression editor, local store and software preview; focused `13/13`, full `358/358`, package/native self-test and real-window visual audit | `MERGED / WINDOWS_CODE_BUILD_CONFIRMED / ENTITY_EXECUTION_FAIL_CLOSED / WIRE_NOT_FROZEN` |
...
11. **T15D custom choreography — WINDOWS EDITOR MERGED/BUILT/LAUNCHED; WIRE NOT FROZEN.** `codex/t15d-desktop-choreography-editor@0d079a5d72349c7468db8d2c01215b021c026a29` is fast-forwarded into this integration and implements the strict local store/compiler, 2–8-column Yaw/Pitch/Expression editor and truthful software preview. Main-Agent verification passes focused `13/13`, full Desktop `358/358`, package/native self-test and real-window visual inspection. Entity execution remains visibly disabled behind a fail-closed pending adapter. New Host/Link IDs and both firmware endpoints stay blocked on the current four-preset physical HIL so the accepted T15 baseline is not destabilized. Design: [`t15d-choreography-editor-v1.md`](../docs/design/t15d-choreography-editor-v1.md); handoff: [`t15d-desktop-choreography-editor-2026-09-02.md`](../docs/handoffs/t15d-desktop-choreography-editor-2026-09-02.md).
