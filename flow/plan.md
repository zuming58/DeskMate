...
- T06 已按用户完整人工矩阵锁定。当前开放 T07 桌面陪伴界面候选：从精确 T06 HEAD `619d85347499545e9af11488bb5d141296ae1dd3` 保留功能基线，加入八入口导航、AI 陪伴统一页面和七状态图片表情库；只做软件与模拟能力，不接线、不写小智、不驱动 OLED/舵机、不实现未冻结 DeskMate Link。
