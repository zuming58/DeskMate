...
| --- | --- | --- | --- |
| T18 current software closure | `codex/t18-software-closure@2dd5347c71be418073f6aac50e10d88f922b8786` | Trusted audio-quiet recovery; ordinary progress notification suppression; ASR glossary/local normalization; real raw-turn history; opt-in Windows local wake; Desktop `411/411`, package/native self-test and local wake process smoke passed | `WINDOWS_CODE_BUILD_CONFIRMED / USER_HIL_PENDING / FIRMWARE_UNCHANGED` |
