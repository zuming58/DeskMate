...
待开发 T23：设置增加“启用小智硬件扩展”总开关及“仅使用 EasyInput”说明。关闭后收起或禁用实体屏幕、表情、舵机与舞蹈入口，显示“已关闭”而非故障；AI 陪伴页面、软件会话形象、语音输入与办公功能保留。该开关不等于关闭 AI 伴侣，也不等于硬件断电。详见 [任务说明](flow/tasks/t23-optional-xiaozhi-hardware.md)，目前仅记录设计要求。
