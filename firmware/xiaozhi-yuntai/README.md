...
当前状态：`T09_THREE_END_INTEGRATED / CROSS_AUDIT_CONFIRMED / TEST_CONFIRMED / BUILD_CONFIRMED / FINAL_APP_CANDIDATE_REBUILT / IDENTITY_CONFIRMED / RECOVERY_BACKUP_CONFIRMED / APP_FLASH_AUTH_PENDING / HIL_NOT_AUTHORIZED`。
