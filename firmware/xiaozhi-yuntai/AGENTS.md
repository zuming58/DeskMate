...
- 目标工具链由项目冻结为 ESP-IDF 5.5.3；当前状态为 `T09_VISIBLE_STATE_HIL_CONFIRMED / OLED_ANIMATION_POLISH_CODE_ONLY / T10_MOTION_SAFETY_CORE_V1_FROZEN / MOTION_HARDWARE_LOCKED`。冻结 Link 合同提交 `c8b8a344a72a849640c8b19575768d6daf4d6667` 必须保持为祖先，Link 合同、黄金向量和 T09 合同只读消费。
