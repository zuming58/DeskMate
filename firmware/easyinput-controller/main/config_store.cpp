...
ConfigLoadResult ConfigNvsStore::load(){
  ConfigSlotRecord a{},b{}; ConfigSlot marker=ConfigSlot::Invalid; uint8_t m=0; bool marker_present=false;
  ...
  ConfigLoadResult legacy{}; nvs_handle_t h=0; bool legacy_present=false;
