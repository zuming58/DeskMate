...
class ConfigWriteAssembler {
 public: ConfigReceiveStatus accept(const uint8_t*,size_t,uint32_t); void abort(); const ConfigDocument& document() const{return document_;}
...
struct ConfigReadRequest { uint32_t request_id{}; };
...
enum class ConfigActionKind:uint8_t { Disabled,VoiceInput,VoiceEdit,Enter,Backspace,SelectAll,Copy,Paste,Undo,Hotkey,Unsupported };
struct ConfigAction { ConfigActionKind kind{ConfigActionKind::Disabled}; uint8_t modifiers{},usage{}; };
struct ConfigProjection { std::array<ConfigAction,8> keys{}; ConfigAction encoder_press{}; bool encoder_cursor{},encoder_horizontal{},reverse_vertical{},reverse_horizontal{}; uint8_t encoder_speed{3}; };
