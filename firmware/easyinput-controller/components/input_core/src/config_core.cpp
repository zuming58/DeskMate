...
bool ConfigStatusStream::replace(uint32_t id, uint32_t epoch,
  ...
  const int written = std::snprintf(
      ...
      static_cast<unsigned long>(motion.accepted),
      static_cast<unsigned long>(motion.endpoint_acknowledgements),
      static_cast<unsigned long>(motion.malformed),
      static_cast<unsigned long>(motion.duplicates),
      static_cast<unsigned long>(motion.busy),
      static_cast<unsigned long>(motion.stale),
      static_cast<unsigned long>(motion.conflicts),
      static_cast<unsigned long>(motion.lifecycle_clears),
      static_cast<unsigned long>(motion.response_drops),
