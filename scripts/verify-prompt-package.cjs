...
assert(main.includes('t40b-style-studio-detent-wheel'));
...
for (const filename of ['source.png', 'paper.png', 'yarn.png', 'glass.png', 'clay.png', 'pixel.png', 'ink.png', 'chrome.png', 'storybook.png', 'jelly.png', 'dial.png', 'manifest.json']) {
...
console.log('T40B packaged resource check passed: dial-press lease, whole-page wheel routing, detent sound, Image 2 adapter/secure store/journal, eject interaction, nine Style Studio presets, renderer, companion videos, sidebar images, recovery, voice resources and exact native bridge.');
