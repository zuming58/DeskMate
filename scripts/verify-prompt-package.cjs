...
assert(main.includes('t51-personal-reminders'));
...
console.log('T51 packaged resource check passed: local personal reminders, Workbench UI, backup/restore, exhibition introduction, guarded barge-in, Style Studio, renderer, companion videos, recovery, voice resources and exact native bridge.');
