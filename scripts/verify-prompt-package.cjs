...
assert(main.includes('t49-guard-false-barge-in'));
...
console.log('T49 packaged resource check passed: guarded ordinary barge-in, immediate explicit pause commands, runtime-truthful companion embodiment, deterministic identity answers, Style Studio, renderer, companion videos, recovery, voice resources and exact native bridge.');
