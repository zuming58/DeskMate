...
assert(main.includes('t59-vocabulary-ui-polish'));
...
console.log('T59 packaged resource check passed: vocabulary UI polish, motion-owned dance audio build, reminder purpose/deletion, Workbench UI, backup/restore, Style Studio, renderer, companion videos and exact native bridge.');
