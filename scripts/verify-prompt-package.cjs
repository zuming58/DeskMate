...
assert(main.includes('t55-reminder-conversation'));
...
console.log('T55 packaged resource check passed: reminder conversation build, fast endpoint, reminder completion/retries, TTS-only announcements, Workbench UI, backup/restore, Style Studio, renderer, companion videos and exact native bridge.');
