...
assert(main.includes('t46-style-studio-internal-drop'));
...
console.log('T46 packaged resource check passed: reliable internal material-to-machine drop, S3 save stays in Style Studio, adaptive S1-S8 routing, volatile encoder-press lease, hardware capability gate, material/result trash drop, pointer-following eject, staged Reveal controls, ten Style Studio presets, Image 2 adapter/secure store/journal, renderer, companion videos, recovery, voice resources and exact native bridge.');
