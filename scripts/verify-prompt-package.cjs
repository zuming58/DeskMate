...
assert(main.includes('t48-companion-embodiment-persona'));
...
console.log('T48 packaged resource check passed: runtime-truthful companion embodiment, deterministic identity answers, pointer-owned material insertion, Style Studio key/lease/save flows, Image 2 adapter/secure store/journal, renderer, companion videos, recovery, voice resources and exact native bridge.');
