...
assert(main.includes('t50-companion-exhibition-intro'));
...
console.log('T50 packaged resource check passed: local exhibition introduction, guarded ordinary barge-in, immediate explicit pause commands, runtime-truthful companion embodiment, deterministic identity answers, Style Studio, renderer, companion videos, recovery, voice resources and exact native bridge.');
