...
assert(main.includes('t54-fast-endpoint'));
...
console.log('T54 packaged resource check passed: fast endpoint build, natural reminders and early interruption, reminder completion/retries, TTS-only announcements, Workbench UI, backup/restore, Style Studio, renderer, companion videos and exact native bridge.');
