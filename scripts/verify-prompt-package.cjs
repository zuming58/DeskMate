...
assert(main.includes('t47-style-studio-pointer-drop'));
...
console.log('T47 packaged resource check passed: pointer-owned material insertion, S3 save stays in Style Studio, adaptive S1-S8 routing, volatile encoder-press lease, hardware capability gate, material/result trash drop, pointer-following eject, staged Reveal controls, ten Style Studio presets, Image 2 adapter/secure store/journal, renderer, companion videos, recovery, voice resources and exact native bridge.');
