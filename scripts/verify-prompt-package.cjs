...
assert(main.includes('t40a-style-studio-dial-press'));
...
console.log('T40A packaged resource check passed: dial-press lease, Image 2 adapter/secure store/journal, eject interaction, nine Style Studio presets, renderer, companion videos, sidebar images, recovery, voice resources and exact native bridge.');
