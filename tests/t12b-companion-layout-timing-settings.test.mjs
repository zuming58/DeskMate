...
test("manual companion seconds accept official boundaries and reject invalid drafts", () => {
  assert.deepEqual(parseCompanionPreferenceDraft({ name: "小言", wakePhrase: "你好，小言", endSmoothSeconds: "0.5", idleTimeoutSeconds: "0" }), {
    ok: true,
    value: { name: "小言", wakePhrase: "你好，小言", endSmoothWindowMs: 500, idleTimeoutMs: 0, conversationVolume: 75, codexBriefVolume: 30, wakeEnabled: false },
  });
  ...
  assert.deepEqual(companionPreferencesToDraft({ name: "阿言", wakePhrase: "你好，阿言", endSmoothWindowMs: 5500, idleTimeoutMs: 90000 }), { name: "阿言", wakePhrase: "你好，阿言", endSmoothSeconds: "5.5", idleTimeoutSeconds: "90", conversationVolume: 75, codexBriefVolume: 30, wakeEnabled: false });
